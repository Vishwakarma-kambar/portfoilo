                ...
                <Card key={index} className="shadow-card hover-glow transition-smooth animate-slide-in-left">
                  <CardHeader>
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                      <div>
                        <CardTitle className="text-xl text-gradient">{edu.degree}</CardTitle>
          ...
          <div>
            ...
            <Card className="shadow-card hover-glow transition-smooth animate-fade-in">
              <CardHeader>
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                  <div>
                    <CardTitle className="text-xl text-gradient">{certification.title}</CardTitle>
                    <p className="text-muted-foreground mt-1">{certification.provider}</p>
                  </div>
